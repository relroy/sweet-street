...
ActiveRecord::Schema.define(version: 20160126131457) do
  ...
  create_table "fundraiser_items", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "name"
    t.string   "photo"
  ...
  create_table "fundraiser_pictures", force: true do |t|
    t.string   "name"
    t.text     "description"
    t.string   "photo"
    t.datetime "created_at"
  ...
  create_table "fundraisers", force: true do |t|
    t.string   "name"
    t.string   "photo"
    t.decimal  "sm_bag",     precision: 10, scale: 0
    t.datetime "created_at"
    t.datetime "updated_at"
  end
